...
export default class AddSPD extends Component {
  ...
  saveUserInfo() {
    ...
    for (var i = 380; i < 781; i++)
    {
      ...
      // Calculate CPPR
      a = a + potencySSD[i-380] * Number(this.state.spd_value[i]);
      b = b + photossd[i-380] * Number(this.state.spd_value[i]);
    }
    ...
    alert("CPPR: " + a/b + " CB Potency: " + sum/tsum*100);
    console.log(a/b);
