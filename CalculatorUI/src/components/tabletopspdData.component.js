  ...
  render() {
    ...
    return (
      ...
      <h3> Table Top Measurement </h3>
        ...
        Select 2 SPD values for the conversion ratio <br/>
          ...
          <div className="col-md-6">
            {isSelected? (
              <div>
              2 values selected. Please import CSV to make calculations
              </div>
            ) : (
              <div>
              Please make selection(s) as {valss} value(s) selected.
              </div>
            )}
          </div>
        </div>
